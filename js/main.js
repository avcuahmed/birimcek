...
window.loadComponents = async () => {
    const parts = [
        ...
        { url: "./components/drawers.html", target: "drawers-container" },
...
window.renderCart = () => {
    ...
    cartBody.innerHTML = window.cart.map((item, index) => {
        ...
        return `
          <div class="cart-item">
            <img src="${item.imgUrl}" class="card-product-img" style="width:48px;height:48px;object-fit:cover;border-radius:6px;">
